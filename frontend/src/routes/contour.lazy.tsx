...
export const Route = createLazyFileRoute('/contour')({
  component: App,
})

const DATA_URL = 'https://raw.githubusercontent.com/visgl/deck.gl-data/master/examples/contour/covid-by-county.json' // eslint-disable-line
